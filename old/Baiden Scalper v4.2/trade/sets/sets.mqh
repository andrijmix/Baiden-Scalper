...
void load_set(int i) {
    ...
    sets[i].atr_under = atr_under;
    
    //Recovery
    sets[i].use_recovery = use_recovery;
    sets[i].use_arithmetic_multiplier = use_arithmetic_multiplier;
    ...
    sets[i].bar_to_reduce = bar_to_reduce;
    sets[i].take_reduce = take_reduce;
    sets[i].take_reduce_limit = take_reduce_limit;
