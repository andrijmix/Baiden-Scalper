...
void activate_signals() {
    if (signals[0].std_period != 0) signals[0].active = true;
    if (signals[1].std_period != 0) signals[1].active = true;
    if (signals[2].std_period != 0) signals[2].active = true;
    if (signals[3].std_period != 0) signals[3].active = true;
    if (signals[4].std_period != 0) signals[4].active = true;
    if (signals[5].std_period != 0) signals[5].active = true;
    if (signals[6].std_period != 0) signals[6].active = true;
    if (signals[7].std_period != 0) signals[7].active = true;    
    if (signals[8].std_period != 0) signals[8].active = true;
    if (signals[9].std_period != 0) signals[9].active = true;
    if (signals[10].std_period != 0) signals[10].active = true;
    if (signals[11].std_period != 0) signals[11].active = true;
    if (signals[12].std_period != 0) signals[12].active = true;
    if (signals[13].std_period != 0) signals[13].active = true;
    if (signals[14].std_period != 0) signals[14].active = true;
}
